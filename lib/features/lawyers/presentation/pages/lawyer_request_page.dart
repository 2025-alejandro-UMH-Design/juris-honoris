...
class LawyerRequestPage extends StatefulWidget {
  ...
  // En demo: cuántas solicitudes usó este mes y si es plan free
  final int solicitationsUsed;
  final bool isPlanFree;

  const LawyerRequestPage({
    super.key,
    required this.lawyer,
    this.solicitationsUsed = 1,
    this.isPlanFree = true,
  });
...
class _LawyerRequestPageState extends State<LawyerRequestPage> {
  ...
  bool get _limitReached =>
      widget.isPlanFree && widget.solicitationsUsed >= _maxFree;
            ...
            children: [
              ...
              Row(
                children: ['Normal', 'Urgente'].map((u) {
                  ...
                  final color =
                      u == 'Urgente' ? AppColors.errorRed : AppColors.primaryBlue;
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Esta será tu solicitud ${widget.solicitationsUsed + 1}/$_maxFree del mes (Plan Gratuito).',
                          style: const TextStyle(
                            fontSize: 13,
                            color: AppColors.greyDark,
                            height: 1.4,
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text(
          ...
          style: TextStyle(fontSize: 14, color: AppColors.subtitleGrey, height: 1.5),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.of(context).pop(),
